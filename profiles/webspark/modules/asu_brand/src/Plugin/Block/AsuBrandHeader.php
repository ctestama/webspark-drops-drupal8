...
class AsuBrandHeader extends AsuBrandBlockBase {
  ...
  public function build() {
    ...
    $build['#attached']['html_head'][] = [
      ...
      [
        ...
        '#value' => '#block-asubrandheader{width:100%;}',
    ...
    $build['#attached']['html_head'][] = [
      ...
      [
        ...
        '#tag' => 'div',
        // Add JavaScript to the <script> tag.
        '#value' => \Drupal\Core\Render\Markup::create($this->fetchExternalMarkUp($this->getIncludesUri())),
        // Give weight so it appears after meta tags, etc.
        '#weight' => -1,
      ],
      'head_template'
  ...
  private function getIncludesUri() {
    $basepath = ASU_BRAND_HEADER_BASEPATH_DEFAULT;
    $version = ASU_BRAND_HEADER_VERSION_DEFAULT;
    $template_key = ASU_BRAND_HEADER_TEMPLATE_DEFAULT;

    return "{$basepath}/{$version}/heads/{$template_key}.shtml";
  }
